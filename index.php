...
<title>Simple Calculator (monolithic - 1)</title>
...
var operation = $( "#operation_display" ).val();
  ...
  $.ajax({url: "calculator_calculations.php",data: { first_number: first_number, second_number: second_number, operation: operation },dataType: 'JSON',method: 'post',success: function(result){
